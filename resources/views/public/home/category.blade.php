            ...
            <div class="col-md-6 mgb-30" data-aos="fade-up" data-aos-duration="2000">
                <div class="list-item">
                    ...
                    <div class="list-cache relative">
                        <h2><a href="<?= route('project',['project_id' => $project->id]) ?>" title="">{{$project->trans('title')}}</a></h2>
                        <div class="list-ls">
                            <div class="row">
                                @foreach ($bugCates as $bugCate)
                                    <div class="col-md-6">
                                        <div class="ls-item flex">
                                            <a href="<?= route('project',['project_id' => $project->id,'category_id' => $bugCate->id]) ?>" title="" class="zoom"><img
                                                    src="{{$bugCate->thumbnail}}"
                                                    alt=""> </a>
                                            <div>
                                                <h4><a href="<?= route('project',['project_id' => $project->id,'category_id' => $bugCate->id]) ?>" title="">{{$bugCate->trans('title')}}</a></h4>
            ...
            <div class="row">
                ...
                <div class="col-md-3" data-aos="fade-up" data-aos-duration="2000">
                    <div class="re-item flex">
                        <a href="<?= route('project',['project_id' => $othc->id]) ?>" title="" class="zoom"><img src="{{$othc->thumbnail}}"
                                                                                       alt=""> </a>
                        <div class="re-text">
                            <h4><a href="<?= route('project',['project_id' => $othc->id]) ?>" title="{{$othc['title']}}">{{ $othc->trans('title') }}</a></h4>
                            <p><span>200</span> lỗi</p>
                        </div>
                    </div>
                </div>
